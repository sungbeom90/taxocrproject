...
def detection_preprocess(image: Image):
    ...
    cv2.imshow("y100 erode", horizontal_img)
    cv2.waitKey(0)
    cv2.destroyAllWindows()

    horizontal_img = cv2.dilate(horizontal_img, horizontal_kernel, iterations=1)

    cv2.imshow("y100 dilate", horizontal_img)
    cv2.waitKey(0)
    cv2.destroyAllWindows()
    ...
    cv2.imshow("x100 erode", vertical_img)
    cv2.waitKey(0)
    cv2.destroyAllWindows()

    vertical_img = cv2.dilate(vertical_img, vertical_kernel, iterations=1)

    cv2.imshow("x100 dilate", vertical_img)
    cv2.waitKey(0)
    cv2.destroyAllWindows()

    mask_img = horizontal_img + vertical_img

    cv2.imshow("img brodcasting", mask_img)
    cv2.waitKey(0)
    cv2.destroyAllWindows()
    ...
    cv2.imshow("THRESH_BINARY_re", re2_img)
    cv2.waitKey(0)
    cv2.destroyAllWindows()
